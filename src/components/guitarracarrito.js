...
const GuitarraCarrito = ({ guitarra }) => {
    ...
    return (
        ...
        <>
            {
                isClient && (
                    <main className="my-5 border-b border-gray-200">
                        ...
                        <div className="flex flex-col items-stretch">
                            ...
                            <div className="flex gap-x-10 ">
                                ...
                                <div className="">
                                    ...
                                    <p className="text-lg flex-grow font-bold uppercase font-lato ">Precio Unitario: <span className="font-normal">{formatearDinero(precio)}</span> </p>
                                    <p className="text-lg flex-grow font-bold uppercase font-lato ">SUBTOTAL: <span className="font-black font-lato text-xl">{formatearDinero(precio * cantidad)}</span> </p>
                                </div>
                            </div>
